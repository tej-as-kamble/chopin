...
const FlagForm = ({ onClose, onConfirm }) => {
    ...
    const warningOptions = [
        ...
        {
            id: 3,
            value: "Bad Food Quality",
            label: "Bad Food Quality"
        },
        {
            id: 5,
        ...
        {
            id: 4,
            value: "Serious Complaints From Delivery Partner",
            label: "Serious Complaints From Delivery Partner"
        },
        {
            id: 6,
            value: "Other",
    ...
    return (
        ...
        >
            <div className="rest-details-form-group">
                <label className="rest-details-form-label">Flag Reason<span className="rest-details-error-text">*</span></label>
                <select
