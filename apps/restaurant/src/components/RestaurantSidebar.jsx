  ...
  return (
    <aside className={`rs-sidebar ${collapsed ? "collapsed" : ""}`}>
      ...
      <nav className="rs-nav">
        <NavLink to="/orders" className="rs-link">
          <FiShoppingBag />
          <span>Orders</span>
        </NavLink>

        <NavLink to="/menu" className="rs-link">
          <FiBookOpen />
          <span>Menu</span>
        </NavLink>

        <NavLink to="/earnings" className="rs-link">
          <FiDollarSign />
          <span>Earnings</span>
        </NavLink>

        <NavLink to="/schedule" className="rs-link">
          <FiClock />
          <span>Schedule</span>
        </NavLink>

        <NavLink to="/offers" className="rs-link">
          <FiTag />
          <span>Offers</span>
        </NavLink>
        ...
        <NavLink to="/reviews" className="rs-link">
          <FiAlertCircle />
          <span>Reviews</span>
        </NavLink>

        <NavLink to="/help" className="rs-link">
          <FiHelpCircle />
          <span>Help</span>
        </NavLink>
      </nav>
