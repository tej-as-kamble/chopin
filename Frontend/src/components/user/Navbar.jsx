    ...
    <nav className="navbar">
      <div className="navbar-left">
        ...
        <div className="location-wrapper">
          <Link to="/address" className="navbar-location-link">
            <span className="navbar-location">Select Location Lorem ipsum dolor sit, amet consectetur adipisicing elit. Alias dolorem corrupti tempore facere, unde aut ipsum possimus saepe, velit maiores qui laboriosam, quas eos. Molestias obcaecati magni quibusdam consectetur commodi!</span>
